...
namespace Iowa.SqlServer.DataAccess.Migrations
{
    ...
    [Migration("20240128231145_AdjustedGameAggregateToFitNewRules")]
    partial class AdjustedGameAggregateToFitNewRules
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("Iowa.Domain.GameAggregate.ValueObjects.Card", "Cards", b1 =>
                        {
                            ...
                            b1.Property<long>("PunishmentValueDefault")
                                .HasColumnType("bigint");

                            b1.Property<long?>("PunishmentValueLower")
                                .HasColumnType("bigint");

                            b1.Property<long?>("PunishmentValueUpper")
                                .HasColumnType("bigint");
